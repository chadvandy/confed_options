...
local function do_other_function(culture, option)
    local subc_str = "subculture:"..culture
    -- welf stuff
    ...
    elseif culture == "wh_main_sc_brt_bretonnia" then
        if option == "free_confed" then
            core:remove_listener("Bret_Tech_FactionTurnStart")
            cm:force_diplomacy(subc_str, subc_str, "form confederation", true, false, false)
        elseif option == "player_only" then
            core:remove_listener("Bret_Tech_FactionTurnStart")

            cm:force_diplomacy(subc_str, subc_str, "form confederation", false, true, false)
            ...
            for i = 1, #human_factions do
                ...
                if faction:culture() == "wh_main_brt_bretonnia" then
                    ...
                    cm:force_diplomacy("faction:"..faction:name(), subc_str, "form confederation", true, false, false)
                end
            end
        elseif option == "disabled" then
            core:remove_listener("Bret_Tech_FactionTurnStart")
            cm:force_diplomacy(subc_str, subc_str, "form confederation", false, false, true)
        elseif option == "no_tweak" then
            -- do literally nothing
        end
